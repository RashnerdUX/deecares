            ...
            <section className="relative min-h-217.5 flex items-center overflow-hidden bg-surface">
                <div className="max-w-300 mx-auto px-6 grid md:grid-cols-2 gap-12 items-center z-10 py-section">
                    ...
                    <div className="space-y-8">
                        <span className="inline-block px-4 py-1.5 bg-secondary text-secondary-foreground font-label-md rounded-full">EST. 2026 • NIGERIA</span>
                        <h1 className="font-bold text-[64px] leading-tight text-primary">Empowering Aging with <span className="text-secondary">Dignity and Joy</span></h1>
                    ...
                    <div className="relative">
                        ...
                        {/* Image frame */}
                        <div className="absolute -bottom-6 -left-6 w-48 h-48 bg-secondary rounded-lg -z-10 animate-pulse"></div>
